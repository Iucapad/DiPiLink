...
class AppSettings {
    ...
    setAppValue = (key, value) => {
        key==="hosts" ? this.appSettings["hosts"].push(value) : this.appSettings[key] = value;
        this.saveSettings(false);
    }
    setUser = u => {
        this.usObj = u;
        if (u.storage && u.storage.dpl_settings) {
            Object.assign(this.currentSettings, u.storage.dpl_settings);
        }
        applyColor();
    }
