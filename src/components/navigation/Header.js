    ...
    getMode(current) {
        ...
        default:
            <>           
                ...
                <Tab state={this.props.state.currentTab} id="confTab" text={intl.formatMessage({id:"tab.iniSetTab"})} handleClick={this.handleClick.bind(this)} appState={this.props.appState}></Tab>
                <Tab state={this.props.state.currentTab} id="aboutTab" text={intl.formatMessage({id:"tab.aboutTab"})} handleClick={this.handleClick.bind(this)} appState={this.props.appState}></Tab>
            </>,
        bridge:
            <>            
                ...
                <Tab state={this.props.state.currentTab} id="statsTab" text={intl.formatMessage({id:"tab.statsTab"})} handleClick={this.handleClick.bind(this)} appState={this.props.appState}></Tab>
                <Tab state={this.props.state.currentTab} id="confTab" text={intl.formatMessage({id:"tab.setTab"})} handleClick={this.handleClick.bind(this)} appState={this.props.appState}></Tab>
                <Tab state={this.props.state.currentTab} id="aboutTab" text={intl.formatMessage({id:"tab.aboutTab"})} handleClick={this.handleClick.bind(this)} appState={this.props.appState}></Tab>
            </>
        }
